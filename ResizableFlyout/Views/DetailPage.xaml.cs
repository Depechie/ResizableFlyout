...
namespace ResizableFlyout.Views
{
    ...
    public sealed partial class DetailPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Item = ItemViewModel.FromItem(DataService.GetItemById((int)e.Parameter));
        ...
        private void OnPageRootLoaded(object sender, RoutedEventArgs e)
        {
            if (ShouldGoToWideState())
            {
                // We shouldn't see this page since we are in "wide master-detail" mode.
        ...
        private void OnPageRootUnloaded(object sender, RoutedEventArgs e)
        {
            Window.Current.SizeChanged -= Window_SizeChanged;
        }
    }
